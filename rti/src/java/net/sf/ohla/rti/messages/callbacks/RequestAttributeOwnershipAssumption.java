...
public class RequestAttributeOwnershipAssumption
  extends
  AbstractMessage<FederateMessageProtos.RequestAttributeOwnershipAssumption, FederateMessageProtos.RequestAttributeOwnershipAssumption.Builder>
  implements Callback
{
  ...
  {
    super(FederateMessageProtos.RequestAttributeOwnershipAssumption.newBuilder());
  ...
  public RequestAttributeOwnershipAssumption(CodedInputStream in)
    throws IOException
  {
    super(FederateMessageProtos.RequestAttributeOwnershipAssumption.newBuilder(), in);
  }
  ...
  {
    return MessageProtos.MessageType.REQUEST_ATTRIBUTE_OWNERSHIP_ASSUMPTION;
  }

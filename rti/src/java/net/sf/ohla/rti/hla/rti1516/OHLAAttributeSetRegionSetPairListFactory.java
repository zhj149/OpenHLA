...
public class OHLAAttributeSetRegionSetPairListFactory
  implements AttributeSetRegionSetPairListFactory
{
  public OHLAAttributeSetRegionSetPairListFactory()
  {
  }

  public AttributeSetRegionSetPairList create(int capacity)
  {
    return new OHLAAttributeSetRegionSetPairList(capacity);
  }
}

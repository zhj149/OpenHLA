...
public class OHLAHLAfixedRecord
  extends OHLADataElement
  implements HLAfixedRecord
{
  protected final List<DataElement> dataElements = new ArrayList<DataElement>();

  public OHLAHLAfixedRecord()
  {
  }

  public OHLAHLAfixedRecord(DataElement dataElement)
  {
    add(dataElement);
  }

  public OHLAHLAfixedRecord(DataElement dataElement1, DataElement dataElement2)
  {
    add(dataElement1);
    add(dataElement2);
  }

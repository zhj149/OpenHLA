...
public class IEEE1516eSupplementalReflectInfo
  implements FederateAmbassador.SupplementalReflectInfo
{
  private final FederateHandle producingFederate;
  private final RegionHandleSet sentRegions;

  public IEEE1516eSupplementalReflectInfo(FederateHandle producingFederate, RegionHandleSet sentRegions)
  {

  ...
  implements HLAinteger64TimeFactory
{
    ...
    throws CouldNotDecode
  {
    ...
    else if ((buffer.length - offset) < IEEE1516eHLAinteger64Time.ENCODED_LENGTH)
    {
      throw new CouldNotDecode(I18n.getMessage(
        ExceptionMessages.DECODE_BUFFER_IS_TOO_SHORT,
        IEEE1516eHLAinteger64Time.ENCODED_LENGTH, buffer.length - offset));
    }
    ...
    throws CouldNotDecode
  {
    ...
    else if ((buffer.length - offset) < 8)
    {
      throw new CouldNotDecode(I18n.getMessage(
        ExceptionMessages.DECODE_BUFFER_IS_TOO_SHORT,
        IEEE1516eHLAinteger64Interval.ENCODED_LENGTH, buffer.length - offset));
    }

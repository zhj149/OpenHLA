...
namespace rti1516
{
  ...
  public:
    ...
    virtual LogicalTimeInterval& operator=(LogicalTimeInterval& const value)
    ...
    virtual LogicalTimeInterval& operator-=(LogicalTimeInterval& const subtrahend)
      throw(InvalidLogicalTimeInterval) = 0;
    
    virtual bool operator>(LogicalTimeInterval& const  value) const
      throw(InvalidLogicalTimeInterval) = 0;

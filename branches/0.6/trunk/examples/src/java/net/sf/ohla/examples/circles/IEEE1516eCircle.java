...
public class IEEE1516eCircle
  extends HLACircle<ObjectInstanceHandle>
{
  private final IEEE1516eCirclesFederate circlesFederate;
  ...
  public IEEE1516eCircle(ObjectInstanceHandle objectInstanceHandle, String objectInstanceName,
                         IEEE1516eCirclesFederate circlesFederate, ObjectClassHandle circleObjectClassHandle)
    throws Exception
  {
    this(objectInstanceHandle, objectInstanceName, circlesFederate, circleObjectClassHandle, false);
  }

  public IEEE1516eCircle(IEEE1516eCirclesFederate circlesFederate, ObjectClassHandle circleObjectClassHandle)
    throws Exception
  {
  ...
  private IEEE1516eCircle(
    Pair<ObjectInstanceHandle, String> objectInstanceHandleAndName, IEEE1516eCirclesFederate circlesFederate,
  ...
  private IEEE1516eCircle(
    ObjectInstanceHandle objectInstanceHandle, String objectInstanceName, IEEE1516eCirclesFederate circlesFederate,
    ObjectClassHandle circleObjectClassHandle, boolean owned)
    throws Exception
  {

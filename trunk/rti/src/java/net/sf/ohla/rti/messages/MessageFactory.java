...
{
  public static Message createMessage(ChannelBuffer buffer, LogicalTimeFactory logicalTimeFactory)
  {
    ...
    switch (type)
    {
      ...
      case REQUEST_FEDERATION_SAVE_RESPONSE:
        message = new RequestFederationSaveResponse(buffer, logicalTimeFactory);
        break;
      ...
      case PUBLISH_INTERACTION_CLASS:
        message = new PublishInteractionClass(buffer);
        break;
      ...
      case INITIATE_FEDERATE_SAVE:
        message = new InitiateFederateSave(buffer, logicalTimeFactory);
        break;
      ...
      case FEDERATE_STATE_FRAME:
        message = new FederateStateFrame(buffer);
        break;
      default:
        throw new Error();
    }

...
public class GetUpdateRateValueForAttribute
  extends
  AbstractRequest<FederationExecutionMessageProtos.GetUpdateRateValueForAttribute, FederationExecutionMessageProtos.GetUpdateRateValueForAttribute.Builder, GetUpdateRateValueForAttributeResponse>
implements FederationExecutionMessage
{
  public GetUpdateRateValueForAttribute(ObjectInstanceHandle objectInstanceHandle, AttributeHandle attributeHandle)
  {
    super(FederationExecutionMessageProtos.GetUpdateRateValueForAttribute.newBuilder());
  ...
  public GetUpdateRateValueForAttribute(CodedInputStream in)
    throws IOException
  {
    super(FederationExecutionMessageProtos.GetUpdateRateValueForAttribute.newBuilder(), in);
  }
  ...
  {
    return MessageProtos.MessageType.GET_UPDATE_RATE_VALUE_FOR_ATTRIBUTE;
  }

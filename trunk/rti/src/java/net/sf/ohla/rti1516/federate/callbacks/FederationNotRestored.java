...
public class FederationNotRestored
  implements Callback
{
  protected RestoreFailureReason reason;

  public FederationNotRestored(RestoreFailureReason reason)
  {
    this.reason = reason;
  }
  ...
  {
    federate.getFederateAmbassador().federationNotRestored(reason);
  }
}
